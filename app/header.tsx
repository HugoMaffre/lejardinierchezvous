...
export default function Header(){
  ...
  return (
    <nav className="bg-neutral-primary text-gray-900 fixed w-full z-20 top-0 start-0 border-b border-neutral-400">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" className="text-white bg-lime-600 hover:bg-lime-800 box-border border border-transparent focus:ring-4 focus:ring-lime-400 shadow-xs rounded-xl text-sm font-semibold px-3 py-2 cursor-pointer focus:outline-none">Get started</button>
